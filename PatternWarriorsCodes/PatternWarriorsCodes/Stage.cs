...
namespace Library
{
    ...
    public class Stage
    {
        ...
        public Stage(int level,Tema oTema)
        {
            this.oTema = oTema;
            this.level = level;
        ...
        public void startStage()
        {
            ...
            while(acabou != 1)
            {
                ...
                else
                {
                    ...
                    vertex.getAmbient().setHero(false);                
                    vertex = verticesDisponiveis[option-1];
                    vertex.getAmbient().setHero(true);
                }
                if (acabou == 1)
                {
        ...
        public void showHeroPosition()
        {
            ...
            foreach(Vertex<int> vertex in vertices)
            {
                ...
                i++;
                if ( vertex.getAmbient().getHero() == true )
                {
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Stage oStage = new Stage(1, oTema);
            oStage.createGraph();
            oStage.startStage();
